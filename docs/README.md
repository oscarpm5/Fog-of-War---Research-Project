...
# Introduction
In this document we will take a look at what is Fog of War, different aproaches used in videogames, different types of fog of war that exist and we will finally explain how to implement it in our own videogame using some exercises to better comprehend the process.
